...
const url = "https://basis-foundation.ru/news/";
const baseUrl = "https://basis-foundation.ru";

const querySelectors = {
    posts: ".newspage-item",
    title: ".newspage-item-title",
    dateCreationPost: ".newspage-item-date",
    link: ".newspage-item-more a",
    fullText:".stdpage-contents",
}
