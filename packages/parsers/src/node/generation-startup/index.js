...
const url = "https://generation-startup.ru/media-center/";
const baseUrl = "https://generation-startup.ru";

const querySelectors = {
    posts: ".media-center__item",
    title: ".media-center__title",
    dateCreationPost: ".media-center__data",
    link: ".media-center__link",
    fullText:".news-detail__text",
}
