...
const url = "https://iclrc.ru/ru/news";
const baseUrl = "";

const querySelectors = {
    posts: ".other-news__col",
    title: ".upcoming-item__text",
    dateCreationPost: ".upcoming-item__date",
    link: ".upcoming-item",
    fullText:"body > main > section > div > div:nth-child(2)",
}
