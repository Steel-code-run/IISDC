import {competitionsTableName, directionsConstTableName, directionsTableName, grantsTableName} from "../config";
...
CREATE TABLE IF NOT EXISTS ${directionsTableName} (
    ...
    ${competitionsTableName}_id         REFERENCES ${competitionsTableName} (id) ON DELETE CASCADE,
